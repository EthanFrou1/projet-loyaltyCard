...
/**
 * Page Paramètres du compte utilisateur.
 *
 * Sections :
 *  1. Informations du compte  → affiche l'email et le rôle (lecture seule)
 *  2. Changer le mot de passe → formulaire avec vérification de l'ancien mot de passe
 *
 * Appels API :
 *  GET   /api/v1/auth/me           → charger l'email et le rôle
 *  PATCH /api/v1/auth/me/password  → changer le mot de passe
 */
      ...
      <Section title="Informations du compte" icon={User}>
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-400">
            Pour changer votre adresse email, contactez le support.
          </p>
        </div>
      </Section>
